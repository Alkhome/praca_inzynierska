...
class App:
    ...
    def update_instruction(self): #TODO CHANGE VALUES
        if self.exercise_name == "raise_both_hands":
            self.instruction_label["text"] = "podnoszenie obu rak"
        ...
        with self.mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
            ...
            try:
                ...
                def raise_both_hands():
                    ...
                    if angle_right_shoulder < 90 and angle_left_shoulder < 90\
                            and angle_right_elbow > 90 and angle_left_elbow > 90\
                            and self.stage == "down":
                        self.stage = "up"
                        self.current_exercise_count += 1
                        print(f"{self.current_exercise_count} udało się wykonać ćwiczenie")

                    elif left_wrist[1] > left_shoulder[1] and right_wrist[1] > right_shoulder[1]: #(0,0) jest w lewym gornym rogu
                        self.stage = "down"
                ...
                if self.current_exercise_name == "raise_both_hands":
                    raise_both_hands()
